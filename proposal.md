...
The diagram below describes the desired behaviour of the application.
...
The app MUST support the following views:

##### 1. Registration

- Displayed when user first runs app after installation
- Prompts for details of bike:
  - make
  - model
  - colour
  - beacon ID (UUID + major + minor)
- Registers bike data with central server
...
#### 3. Main view (bike missing)

- Changed options
  - I have recovered my bike


### Blueprint

The following blueprint shows the main app views:
...
The following simplified Gantt chart shows the design and development plan for the project. Task owners are not specified as only a single designer/developer is involved.
...
- [5] The moped and scooter crime wave that has swept London - BBC News
